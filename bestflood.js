...
if (process.argv.length < 7) {
 ...
 ${chalk.yellow('BYPASS UAM FUNCTION :' )}
...
${chalk.red('BYPASS HTTP DDOS FUNCTION :' )}
 --bypass   ENABLE UNSUAL UA       [Status: ${chalk.green('ONLINE')}]
 Coming soon...!
     `);
...
headercloudflare = null;
}


let query
if (process.argv.includes('--query')) {
query  = '?__cf_chl_rt_tk=' + randstrr(30) + '_' + randstrr(12) + '-' + timestampString + '-0-' + 'gaNy' + randstrr(8);
} else {
query = null;
}
